 ...
 *
 * Runs with the 'dev' profile to use H2 + in-memory idempotency (no Redis
 * or PostgreSQL required). The contract is identical — ConcurrentHashMap
 * has the same atomic putIfAbsent semantics as Redis SETNX.
 */
@SpringBootTest
@ActiveProfiles("dev")
